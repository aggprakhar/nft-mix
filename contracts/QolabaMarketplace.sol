...
//    */
    ...
    */
    function _clearBid(uint256 tokenId) private {
        payable(idToMarketItem[tokenId].bidder).transfer(msg.value);
    ...
    function acceptBid(uint256 tokenId) public {
        address payable current_owner = idToMarketItem[tokenId].owner;
    ...
    function _settleBid(uint256 tokenId) public {
//        current_owner = msg.sender;
        ...
        _transfer(payable(msg.sender), idToMarketItem[tokenId].owner, tokenId);
    }
